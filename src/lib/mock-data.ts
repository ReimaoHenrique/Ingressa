...
export const eventoMock: Evento = {
  ...
  termosUso: "Ao comprar você concorda com nossos termos de entrada. Proibido menores de 18 anos. Documento obrigatório."
};
