        ...
        <Card className="overflow-hidden">
          <div className="relative h-64 md:h-80">
            <Image
              ...
              onError={(e) => {
                ...
                target.src = "data:image/svg+xml;base64,";
              }}
            />
          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Badge variant={evento.ingressosDisponiveis > 0 ? "default" : "destructive"}>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                ...
                <div className="text-2xl font-bold text-blue-600">{evento.ingressosDisponiveis}</div>
                <div className="text-sm text-gray-600">Ingressos Disponíveis</div>
              </div>
              <div className="text-center p-4 bg-green-50 rounded-lg">
                <div className="text-2xl font-bold text-green-600">{formatPrice(evento.preco)}</div>
                <div className="text-sm text-gray-600">Preço por Ingresso</div>
              </div>
              <div className="text-center p-4 bg-orange-50 rounded-lg">
                <div className="text-2xl font-bold text-orange-600">{percentualVendido.toFixed(0)}%</div>
